...
''')
    ...
    def change_mode(self, mode):
        ...
        while self.vehicle.mode.name != mode:
            ...
            self._log('  ... vehicl mode: {0} '.format(self.vehicle.mode))
            time.sleep(1)
            self.vehicle.mode = VehicleMode(mode)'''
...
class Templates:
    ...
    # public mapbox pk.eyJ1IjoiamVycnlmYXQiLCJhIjoiY2tjczFwZnp0MDJuaDJ6cWpkZHF5YjM1cCJ9.8pwSnCZUuvsm8Tzm_LYt4g
    # jerryfat 'pk.eyJ1IjoiamVycnlmYXQiLCJhIjoiY2w1ZWFrOWF1MHE5dTNrbnh0NG9ocDExbSJ9.CLIXbxDi3gqLVLIUwLp3eg',
    def index(self):
        self.options = self.get_options()
