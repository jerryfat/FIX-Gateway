    ...
    while(vehicle):
        ...
        if (msg != None):
            ...
            if (msg != "") and ( (msgID == 30) or (msgID == 33) or (msgID == 141) or (msgID == 27) or (msgID == 225) or (msgID == 226)):
                ...
                print("\n--@@@@@@@@@@@@@--Received msgId:",msgID," convert, sending to G5 and or Efis(): ", date_time," ", msg," ", end="")
...
async def print_position(drone):
    async for position in drone.telemetry.position():
        ...
        now = datetime.now()
        date_time = now.strftime("%m/%d/%Y, %H:%M:%S")
        print("\n--@@@@@@--Received MAVSDK position msg converting, sending to G5 and or Efis(): ", date_time," ", position)
...
async def print_heading(drone):
    async for heading in drone.telemetry.heading()  :
        ...
        now = datetime.now()
        date_time = now.strftime("%m/%d/%Y, %H:%M:%S")
        print("\n--@@@@@@-Received MAVSDK heading converting, sending to G5 and or Efis(): ", date_time," ", heading)
...
async def print_attitude_euler(drone):
    async for attitude_euler in drone.telemetry.attitude_euler()  :
        ...
        now = datetime.now()
        date_time = now.strftime("%m/%d/%Y, %H:%M:%S")
        print("\n--@@@@@@--Received MAVSDK attitude_euler converting, sending to G5 and or Efis(): ", date_time," ", attitude_euler)
