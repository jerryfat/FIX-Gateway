...
class Templates:
    ...
    def get_options(self):
        return {'width': 670,
                ...
                'zoom': 13,
                'format': 'png',
                'access_token': 'pk.eyJ1IjoiamVycnlmYXQiLCJhIjoiY2w1ZWFrOWF1MHE5dTNrbnh0NG9ocDExbSJ9.CLIXbxDi3gqLVLIUwLp3eg',
                ...
                # orig # 'access_token': 'pk.eyJ1Ijoia2V2aW4zZHIiLCJhIjoiY2lrOGoxN2s2MDJzYnR6a3drbTYwdGxmMiJ9.bv5u7QgmcJd6dZfLDGoykw',
                # 'mapid':           #'kevin3dr.n56ffjoo',
                # jerry fat private token pk.eyJ1IjoiamVycnlmYXQiLCJhIjoiY2w1ZWFrOWF1MHE5dTNrbnh0NG9ocDExbSJ9.CLIXbxDi3gqLVLIUwLp3eg
                #works for jerry
# 'mapbox public access_token': 'pk.eyJ1IjoiamVycnlmYXQiLCJhIjoiY2tjczFwZnp0MDJuaDJ6cWpkZHF5YjM1cCJ9.8pwSnCZUuvsm8Tzm_LYt4g',
# 'mapid': 'mapbox.satellite',
#mapbox.satellite
#mapbox.terrain-rgb
