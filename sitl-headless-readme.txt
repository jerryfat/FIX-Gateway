...
```
docker run --rm -it --env PX4_HOME_LAT=40.19476489083686 --env PX4_HOME_LON=-74.72418260104739 --env PX4_HOME_ALT=488.0 jonasvautherin/px4-gazebo-headless:1.14.0
40.19476489083686, -74.72418260104739
## Manual build
